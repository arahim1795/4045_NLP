...
plt.subplot(2, 1, 1)
plt.bar(word_count_with_stemming_counter.keys(), word_count_with_stemming_counter.values())

plt.subplot(2, 1, 2)
plt.bar(word_count_without_stemming_counter.keys(), word_count_without_stemming_counter.values())
...
print("20 Most Common Words Before Stemming: " + str(words_without_stemming_counter.most_common(20)))
print("20 Most Common Words After Stemming: " + str(words_with_stemming_counter.most_common(20)))
