import sys
sys.path.append('..')
from App.stanford_dependency_utils_v2 import get_noun_adjective_pairs_from_reviews
...
def test_correct_noun_adjective_pair_is_returned_for_sentence_with_long_name():
    noun_adjective_pairs = get_noun_adjective_pairs_from_reviews("Tan Ah Kao is cool and calm.")
...
def test_correct_noun_adjective_pair_is_returned_for_sentence_sentences_with_adverbs_attached_to_adjectives():
    noun_adjective_pairs = get_noun_adjective_pairs_from_reviews("Tan Ah Kao is very cool and very calm.")
    assert("Tan Ah Kao", "very cool") in noun_adjective_pairs 
    assert("Tan Ah Kao", "very calm") in noun_adjective_pairs
    noun_adjective_pairs = get_noun_adjective_pairs_from_reviews("Tan Ah Kao is very cool but not very calm.")
    assert("Tan Ah Kao", "very cool") in noun_adjective_pairs 
